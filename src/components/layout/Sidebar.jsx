        ...
        <div className="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out">
            ...
            <nav className="mt-8">
                <div className="px-4 space-y-2">
                    ...
                    <a href="/entvy_blog_admin/categories/html" className="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200" data-category="html">
